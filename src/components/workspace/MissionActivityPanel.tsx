          ...
          <AnimatePresence initial={false}>
            {reinforcement && (
              ...
              >
                ...
                <p className="text-[11px] text-ink-300"><span className="font-semibold text-white">Renfort disponible :</span> {team.optimizer.name} pourra être sollicité pour une prochaine itération de qualité et de performance.</p>
              </motion.div>
            )}
            {(completed || needsFix) && (
              <motion.div
