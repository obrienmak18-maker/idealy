...
|---|---|---|---|---|
| Voies | Quatre voies : Mage, Ninja, Hunter, Pro ; une seule voie active. | Le runtime possède des personas originaux et une valeur `missions.way`, mais la landing utilise encore `Energy`, `Mana`, `Chakra`, `Les Nains`. | **Partiel** | Centraliser l’énumération des voies et corriger les libellés publics sans toucher aux avatars fournis. |
